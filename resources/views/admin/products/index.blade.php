<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.products.create') }}" class="py-2 px-4 rounded-full bg-blue-500 text-white">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex gap-4">
                                <img src="{{ Storage::url($product->photo) }}" alt="{{ $product->title }}"
                                    class="w-[50px] h-[50px]" />
                                <div>
                                    <h2 class="font-bold text-xl dark:text-neutral-200">{{ $product->title }}</h2>
